...
class CustomerDataInitializer implements DataInitializer {
	...
	public void initialize() {
		...
		UserAccount ua1 = userAccountManager.create("Yassin", "123", customerRole);
		UserAccount ua2 = userAccountManager.create("Imran", "123", customerRole);
		UserAccount ua3 = userAccountManager.create("Nabil", "123", customerRole);
		UserAccount ua4 = userAccountManager.create("Ahmad", "123", customerRole);

		Customer c1 = new Customer(ua1, "London");
		Customer c2 = new Customer(ua2, "Miami");
		Customer c3 = new Customer(ua3, "KL");
